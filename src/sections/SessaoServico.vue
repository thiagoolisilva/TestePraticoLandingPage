    ...
    <div id="features" class="container mx-auto px-5">
        <section class="py-16">
            <div class="w-4/5 md:w-3/5 mx-auto">
                ...
                <p class="text-theme-grayish-blue text-center mt-7 font-theme-content text-lg"> Oferecemos assistência completa em emergências, reparos e manutenção, além de suporte em viagens e carro reserva. Conte conosco para manter seu veículo sempre em movimento!</p>
            </div>
                ...
                <template v-for="feature in features" :key="feature.id">
                    <transition name="fade-slide" mode="out-in">
                        <div v-show="isOpen === feature.id" class="grid gap-32 lg:grid-cols-2 items-center">
                            <div class="relative">
                                <img class="z-10 w-full max-w-lg max-h-lg rounded-lg object-cover" :src="feature.details.imageUrl" />
